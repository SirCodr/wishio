...
export function EmptyState({ title, description, cta, onCta }: MinimalEmptyProps) {
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4">
      ...
      <h3 className="text-xl font-medium text-foreground mb-2">{title || 'Sin contenido aún'}</h3>
